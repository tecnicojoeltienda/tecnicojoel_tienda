...
export default function AccesoriosPage() {
  ...
  const renderProduct = (p) => {
    ...
    const category = (p.categoria || "accesorios").toString().toLowerCase();
      ...
      <main className="w-full mx-0 px-4 sm:px-4 lg:px-4 py-8">
        <div className="flex flex-col lg:flex-row gap-6">
          ...
          <section className="flex-1 order-2">
            <div className="mb-8">
              <h1 className="text-3xl font-bold text-gray-900 mb-3">Accesorios</h1>
              <p className="text-gray-600">Encuentra accesorios para complementar tu setup</p>
            </div>
            ...
            {loading ? (
              ...
              <div className="text-center py-16 bg-white rounded-lg shadow-sm">
                ...
                <h3 className="text-lg font-medium text-gray-900 mb-2">No hay accesorios disponibles</h3>
