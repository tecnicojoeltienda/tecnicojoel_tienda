...
export default function PreacondicionadosPage() {
  ...
  const renderProduct = (p) => {
    ...
    const category = (p.categoria || "reacondicionados").toString().toLowerCase();
          ...
          <section className="flex-1 order-2">
            ...
            {loading ? (
              ...
              <div className="text-center py-16 bg-white rounded-lg shadow-sm">
                <h3 className="text-lg font-medium text-gray-900 mb-2">No hay reacondicionados disponibles</h3>
