...
export default function LaptopsPage() {
  ...
  const renderProduct = (p) => {
    ...
    const category = (p.categoria || "laptops").toString().toLowerCase();
      ...
      <main className="w-full mx-0 px-4 sm:px-4 lg:px-4 py-8">
        <div className="flex flex-col lg:flex-row gap-6">
          ...
          <section className="flex-1 order-2">
            <div className="mb-8">
              <h1 className="text-3xl font-bold text-gray-900 mb-3">Laptops</h1>
              <p className="text-gray-600">Encuentra laptops para trabajo, estudio y gaming</p>
            </div>
            ...
            {loading ? (
              ...
              <div className="text-center py-16 bg-white rounded-lg shadow-sm">
                ...
                <h3 className="text-lg font-medium text-gray-900 mb-2">No hay laptops disponibles</h3>
