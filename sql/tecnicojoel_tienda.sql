...
--
-- Host: localhost    Database: tecnicojoel_tienda
-- ------------------------------------------------------
...
CREATE TABLE `administrador` (
  ...
  `rol` enum('admin','super_admin') COLLATE utf8mb4_general_ci DEFAULT 'admin',
...
INSERT INTO `administrador` VALUES (1,'Joel Ortiz','tecnicojoel','$2b$10$yl/1qEy3bRCq/mmuqZ0VJeA72jjMGaD8FaOuU6lc2q23jr.8JuQXS','super_admin','activo');
...
CREATE TABLE `pedido` (
  ...
  `estado` enum('pendiente','enviado','cancelado','completado') COLLATE utf8mb4_general_ci DEFAULT 'pendiente',
...
CREATE TABLE `producto` (
  ...
  `en_promocion` enum('si','no') COLLATE utf8mb4_general_ci DEFAULT 'no',
  `estado` enum('disponible','agotado') COLLATE utf8mb4_general_ci DEFAULT 'disponible',
...
-- Dump completed on 2025-11-15 16:58:18
